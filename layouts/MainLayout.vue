<template>
  <div id="MainLayout" class="h-screen">
    <div class="w-full max-w-[500px] mx-auto">
      <div
        id="TopMenu"
        class="w-full items-center justify-center px-2 h-10 my-2"
      >
        <img
          class="w-[35px] mx-auto"
          src="https://raw.githubusercontent.com/rstubryan/assets/master/gambar/nuxt-lawaklu/threads-logo.png"
        />
      </div>
    </div>
